...
[GlobalClass][Tool]
public partial class rez_inmateconstantsreprobate : Resource
{
	...
	public rez_inmateconstantsreprobate() : this("disgust", "sadness", "fear", "res://GAMEASSETS/in Fight/field units/player units/animation packs/SpriteFramesF_AnimPackReprobateSprites.tres") {}

	public rez_inmateconstantsreprobate(string highaff, string medaff, string lowaff, string animpackfilepath)
	{
