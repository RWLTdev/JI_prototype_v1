...
[GlobalClass][Tool]
public partial class rez_inmateconstantslouis : Resource
{
	...
	public rez_inmateconstantslouis() : this("disgust", "sadness", "fear", "res://GAMEASSETS/in Fight/field units/player units/animation packs/SpriteFramesF_AnimPackLouisSprites.tres") {}

	public rez_inmateconstantslouis(string highaff, string medaff, string lowaff, string animpackfilepath)
	{
